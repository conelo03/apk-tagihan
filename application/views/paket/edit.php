  ...
  <section class="section">
    ...
    <div class="section-body">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <form action="<?= base_url('edit-paket/'.$paket['id_paket']); ?>" method="post">
              ...
              <div class="card-body">
                <div class="form-group">
                  <label>Paket</label>
                  <input type="text" name="paket" class="form-control" value="<?= set_value('paket', $paket['paket']); ?>" required="">
                  <?= form_error('paket', '<span class="text-danger small">', '</span>'); ?>
                </div>
                <div class="form-group">
                  <label>Tarif</label>
                  <input type="number" name="tarif" class="form-control" value="<?= set_value('tarif', $paket['tarif']); ?>" required="">
